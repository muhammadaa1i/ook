...
const features = [
  {
    ...
    description: "Только лучшие материалы и проверенные производители",
    icon: Shield,
  },
  {
    title: "Быстрая доставка",
    description: "Доставляем по всему Узбекистану в кратчайшие сроки",
    icon: Truck,
  },
  {
  ...
  {
    title: "Лучшие цены",
    description: "Конкурентные цены и регулярные скидки",
    icon: Star,
  },
];
